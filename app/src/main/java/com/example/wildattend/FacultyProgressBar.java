...
public class FacultyProgressBar extends View {
    private Paint paint;
    private RectF rectF;
    private int strokeWidth = 50; // example value
    private int progress = 0;
    private static final String TAG = "FacultyProgressBar";

    public FacultyProgressBar(Context context) {
        super(context);
        init();
    }

    public FacultyProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public FacultyProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
